...
export function OriginalFileIcon({color="black", ...props}: IconProps) {
  return <Icon color={color} {...props}>
    <path stroke="currentcolor" strokeWidth="1.5" fill="none"
    ...
    <path stroke="currentcolor" strokeLinecap="round" strokeWidth="1.5" d="M8 12h8M8 8h8M8 16h5"
      fill="none" />
  </Icon>;
}

export function DestinationFileIcon({color="black", ...props}: IconProps) {
  return <Icon color={color} {...props}>
    <path stroke="currentcolor" strokeLinecap="round" strokeWidth="1.5" fill="none"
